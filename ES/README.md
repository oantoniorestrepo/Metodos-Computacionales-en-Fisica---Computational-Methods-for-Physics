...
| 13 | [Diferenciación Numérica](./Clase_13_Diferenciacion.ipynb) | Derivadas numéricas por diferencias finitas (adelante y centrada), análisis de error e inestabilidad numérica. | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/oantoniorestrepo/Metodos-Computacionales-en-Fisica---Computational-Methods-for-Physics/blob/main/ES/Clase_13_Diferenciacion.ipynb) |
